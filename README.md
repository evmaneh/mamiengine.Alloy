# [Mamiengine.alloy](https://github.com/evmaneh/mamiengine.Alloy)
### A frontend for AlloyProxy customized with the thought of automation and convinience, a node.js web proxy for use in combating web filters

# Updates
```
(Alloy:Updated 3/4/23: V2)
(Mamiengine:Updated 20/12/23: V0.0.1)
```
...
SOFTWARE.
```
### Copyright (c) 2020-2023 Mamiengine
